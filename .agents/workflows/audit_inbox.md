...
## Trigger
When asked to "audit my inbox", "run weekly review", "sort my quick capture", or when explicitly invoking `/audit_inbox`.
...
2. **Categorize and Plan:**
   ...
   - *CRITICAL:* If an item is a task or to-do, recommend it goes to `1.1. Philosophy & Personal North Star/Shit To Do` or an appropriate project note.
...
4. **Present Execution Plan (Interactive):**
   ...
   - Example: "I found 3 distinct items. 1. Move 'Gym Idea' to `2.1. Fitness/Workout Log`. 2. Create new note `Concept - XYZ` in `6.2`. 3. Add to-do to `Shit To Do`. Does this look correct?"
